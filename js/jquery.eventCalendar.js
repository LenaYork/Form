...
;(function( $ ) {
	...
	$.fn.eventCalendar.defaults = {
		...
		locales: {
			locale: "en",
			txt_noEvents: "There are no lessons in this period",
			txt_SpecificEvents_prev: "",
			txt_SpecificEvents_after: "lessons:",
			txt_next: "next",
			txt_prev: "prev",
			txt_NextEvents: "Next lessons:",
			txt_GoToEventUrl: "Book the lesson",
			txt_loading: "loading..."
		},
		showDayAsWeeks: true,
		startWeekOnMonday: true, // false to start weeks from sunday
		...
		//flags.wrap.find('.eventCalendar-list .eventCalendar-eventTitle').live('click',function(e){
			if(!eventsOpts.showDescription) {
				...
				if (!desc.find('a').size()) {
					...
					if (!desc.find('.bt').size())  {
						
						// desc.append('<a href="#hiddenForm" class="bt" onClick="function(){'+ showFrom +'}">Book this lesson</a>');

						desc.append(bookButton);
						// bookButton.setAttribute('href', '#hiddenForm');
						};
					// desc.append('<button id="trialButton">' + 'SOMETEXT' + '</button>');
					// $("#trialButton").css('background-color', 'red');
